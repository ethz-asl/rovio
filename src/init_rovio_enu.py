...
def mag_imu_callback(imuMsg):
    ...
    if resent_to_send and num_external_pose_read > 400: #TODO add me as yaml parameter
        ...
        try:
            ...
            qIC = [0.704754446355, -0.708229159884, -0.0267591331242, 0.0318837925519] # [x,y,z,w]
            ...
            qEnuI_euler = np.add(qEnuI_euler, [0,0,np.deg2rad(77)])#for big vicon room -0.733]) #2.407 for east
            print qEnuI_euler
...
if __name__ == '__main__':
    ...
    rospy.Subscriber("dji_sdk/imu", Imu, mag_imu_callback)
